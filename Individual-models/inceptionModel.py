...
base_model = tf.keras.applications.InceptionResNetV2(weights = None, include_top = False, input_shape = input_shape)
x = base_model.output         
...
save_model = "D:\ASU-Notes\Fall-2022\ML\Project\inceptionModel.h5"
